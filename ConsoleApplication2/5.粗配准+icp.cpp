...
main(int argc, char** argv)
{
	...
	pcl::io::loadPCDFile("第一次.pcd", *cloud_src_o);
	PointCloud::Ptr cloud_tgt_o(new PointCloud);//目标点云
	pcl::io::loadPCDFile("pifu.pcd", *cloud_tgt_o);
	...
	voxel_grid.setLeafSize(0.07,0.07,0.07);
	...
	voxel_grid_2.setLeafSize(0.07, 0.07, 0.07);
	...
	//保存转换的输入点云
	pcl::io::savePCDFileASCII("第二次.pcd", *icp_result);
	//计算误差
